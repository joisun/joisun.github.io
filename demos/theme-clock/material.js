...
const Digital = document.querySelector(
  '#digital-style'
)
...
function update() {
  ...
  function computed() {
    // material clock
    const MeterailClock = {
      hourPointer: document.querySelector(
        '.hour-pointer'
      ),
      minutePointer: document.querySelector(
        '.minute-pointer'
      ),
      secondPointer: document.querySelector(
        '.second-pointer'
      ),
    }
    const TextClock = {
