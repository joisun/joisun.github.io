"use strict";
const RADIOS = document.querySelectorAll('.colornav-item input[type=radio]');
const wrapper = document.querySelector('.iphone14-wrapper');
const figures = document.querySelectorAll('figure.iphone14');
...
function handleRadioChange(e) {
    ...
    RADIOS.forEach((RADIO, index) => {
        if (RADIO.id !== id) {
            ...
            updateViews(id, index);
        }
    });
}
function updateViews(id, index) {
